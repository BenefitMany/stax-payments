...
Gem::Specification.new do |spec|
  ...
  spec.homepage      = 'https://github.com/yourusername/stax-payments'
  spec.license       = 'MIT'
  spec.required_ruby_version = Gem::Requirement.new('>= 2.6.0')

  spec.metadata['source_code_uri'] = 'https://github.com/yourusername/stax-payments'
  spec.metadata['bug_tracker_uri'] = 'https://github.com/yourusername/stax-payments/issues'
